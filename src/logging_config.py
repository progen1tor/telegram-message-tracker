...
all_messages_handler = logging.FileHandler(ALL_MSG_LOG_FILEPATH, encoding='utf-8', mode='a')  
...
target_messages_handler = logging.FileHandler(TGT_MSG_LOG_FILEPATH, encoding='utf-8', mode='a')  
